        ...
        <ParentLayout>
            <template #sidebar-top>
                <div class="sponsors sponsors-top">
                    ...
                    <template v-if="sponsors.platinum.length">
                        <a v-for="sponsor in sponsors.platinum" :href="sponsor.href" :key="sponsor.href" target="_blank"
                            rel="noopener">
                            <img :src="sponsor.imgSrcLight" :alt="sponsor.alt" />
                        </a>
                    </template>
                    <a v-else class="become-sponsor" href="https://github.com/sponsors/posva" target="_blank"
                        rel="noopener" alt="Your logo here">Become a Sponsor!</a>
                </div>
            </template>
            ...
            <template #sidebar-bottom>
                <div class="sponsors">
                    ...
                    <a v-for="sponsor in sponsors.gold" :href="sponsor.href" :key="sponsor.href" target="_blank"
                        rel="noopener">
                        <img :src="sponsor.imgSrcLight" :alt="sponsor.alt" />
                    </a>
                </div>
